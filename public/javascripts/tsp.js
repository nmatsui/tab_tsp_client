...
function formatDirections(gdir, mode) {
	...
	retStr += "\t<tr class='heading'><td class='heading' width=40>"
	    + "<div class='centered-directions'><img src='icons/black.png'></div></td>"
	...
	dragStr += "<li id='" + i + "' class='ui-state-"
	  + (i ? "default" : "disabled") + "'>"
	  + "<table class='dragTable'><tr><td class='left'><img src='icons/black.png' /></td><td class='middle'>" + headerStr + "</td><td class='right'>"
	...
	dragStr += "<li id='" + 0 + "' class='ui-state-disabled'>"
	  + "<table class='dragTable'><tr><td><img src='icons/black.png' /></td><td>" + headerStr
	  + "</td></tr></table></li>"; 
	retStr += "\t<tr class='heading'><td class='heading'>"
	    + "<div class='centered-directions'><img src='icons/beige.png'></div></td>"
	    + "<td class='heading'>"
...
function onSolveCallback(myTsp) {
 // $('#dialogProgress').dialog('close');
	...
	var myIcn1 = new google.maps.MarkerImage("icons/black.png");
	var marker = new google.maps.Marker({ 
            position: myPt1, 
	    icon: myIcn1, 
	    map: myMap });
	...
	if (i == dir.legs.length - 1 && mode == 0) {
	    myIcn1 = new google.maps.MarkerImage("icons/beige.png");
	} else {
	    myIcn1 = new google.maps.MarkerImage("icons/blue.png"); //("icons/blue" + (i+2) + ".png");
	}
	var marker = new google.maps.Marker({
            position: myPt1,
	    icon: myIcn1,
